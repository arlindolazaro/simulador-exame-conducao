    ...
    <main className={styles.page}>
      <section className={styles.heroModern}>
        <div className={styles.heroText}>
          ...
          <p>
            Plataforma para treino com dados locais e feedback imediato. Experiência escura, profissional e focada em conversão.
          </p>
        </div>
        <aside className={styles.heroCard}>
          <p className={styles.heroCardTitle}>Bem-vindo</p>
          {!hasStarted ? (
            <>
              ...
              <p className={styles.heroNote}>{'Preencha o nome para uma experiência mais pessoal.'}</p>
            </>
          ) : !selectedCategory ? (
            <div>
